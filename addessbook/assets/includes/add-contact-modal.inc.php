    ...
    <div class="modal-content">
      ...
      <form method="POST">
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              ...
              <input type="text" class="form-control" name="contact-name" placeholder="John Doe" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              <label for="contact-number" class="col-form-label">Phone Number:</label>
              <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" name="contact-number" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="modal-footer">
          <button type="submit" name="add-btn" class="btn btn-success">Save Contact</button>
