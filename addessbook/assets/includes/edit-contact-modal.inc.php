        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              ...
              <input type="text" class="form-control" name="contact-name" placeholder="John Doe" value="<?php echo $row_data['name']?>" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              <label for="contact-number" class="col-form-label">Phone Number:</label>
              <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" name="contact-number" value="<?php echo $row_data['phone']?>" required>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
              <label for="contact-email" class="col-form-label">Email:</label>
              <input type="email" name="contact-email" class="form-control" value="<?php echo $row_data['email']?>" required>
            </div>
          </div>
        </div>
